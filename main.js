...
nextBtn.addEventListener('click', () => {
        ...
        //     pauseAndPlay()
        //     nextProcess()
        //     console.log("နေရစ်ခဲ့တော့ အလုပ်လုပ်တယ်.....")
        //     index ++;
            
        // }
        else if (index == songs.length-1){
            
            console.log("လေးဖြူသီချင်း.....")
            isPlaying = false
            ...
            console.log(index)
            nextProcess()
            console.log("else If က အပိုင်း " +index)
            pauseAndPlay()
            title.innerText = songs[index].trackName
            isPlaying = true
...
previousBtn.addEventListener('click', () => {
    if (index ==  0) {
        ...
        isPlaying = false
        console.log("ရလာတဲ့ နဂို Index ---->" + index)
        index --;
        let preSong = songs[index].trackSrc;
        console.log("run တဲ့ Index----->" + index)
...
btnRmList.addEventListener('click', ()  => {
    ...
    // if(playImgContainer.classList.contains(imgToRight)) {
